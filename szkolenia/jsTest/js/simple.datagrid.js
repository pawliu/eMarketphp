  ...
  */
  ...
  SimpleDataGrid = (function(_super) {
    ...
    function SimpleDataGrid() {
      _ref = SimpleDataGrid.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    SimpleDataGrid.prototype._generateColumnData = function() {
      ...
      generateFromOptions = function() {
        var column, column_info, key, _i, _len, _ref1;
        _ref1 = _this.options.columns;
    ...
    SimpleDataGrid.prototype._fillGrid = function(data) {
      ...
      addRowFromObject = function(row) {
        var column, html, value, _i, _len, _ref1;
        html = '';
        _ref1 = _this.columns;
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          column = _ref1[_i];
      ...
      addRowFromArray = function(row) {
        var column, html, i, value, _i, _len, _ref1;
        html = '';
        _ref1 = _this.columns;
        for (i = _i = 0, _len = _ref1.length; _i < _len; i = ++_i) {
          column = _ref1[i];
      ...
      fillHeader = function(row_count) {
        var class_html, column, html, is_sorted, order_by, sort_text, _i, _len, _ref1;
